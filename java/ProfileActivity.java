...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void loadUserData() {
        ...
        serverManager.makeRequest("profile.php", formBody, new ServerManager.ServerCallback() {
            @Override
            ...
            public void onError(String error) {
                runOnUiThread(() -> Toast.makeText(ProfileActivity.this, "Erro ao carregar perfil: " + error, Toast.LENGTH_SHORT).show());
            }
        });
    ...
    private void logout() {
        ...
        if (userId != -1 && sessionToken != null) {
            ...
            serverManager.makeRequest("logout.php", formBody, new ServerManager.ServerCallback() {
                @Override
                public void onSuccess(String response) {
                    clearSessionAndExit();
                }
